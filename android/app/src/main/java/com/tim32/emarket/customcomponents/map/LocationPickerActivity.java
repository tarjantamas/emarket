...
public class LocationPickerActivity extends AppCompatActivity implements PermissionsListener, OnMapReadyCallback {
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        Double lat = BundleUtil.getDoubleOrNull(getIntent().getExtras(), LAT);
        Double lng = BundleUtil.getDoubleOrNull(getIntent().getExtras(), LNG);

        mapboxMap.setStyle(Style.MAPBOX_STREETS, style -> {
            if (lat != null && lng != null) {
                moveToLocation(mapboxMap, lat, lng);
            } else {
                moveToLocation(mapboxMap, 45.25, 19.83);
                ...
                public void onClick(View view) {
                    if (hoveringMarker.getVisibility() == View.VISIBLE) {
                        ...
                        selectLocationButton.setBackgroundColor(
                                ContextCompat.getColor(LocationPickerActivity.this, R.color.green));
                        ...
                        resultIntent.putExtra("lng", mapTargetLatLng.getLongitude());
...
//                        reverseGeocode(Point.fromLngLat(mapTargetLatLng.getLongitude(), mapTargetLatLng.getLatitude()));
    ...
    void moveToLocation(@NonNull MapboxMap mapboxMap, Double latitude, Double longitude) {
