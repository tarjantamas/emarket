...
@EViewGroup(R.layout.view_product_row)
public class ProductRowView extends ConstraintLayout {
    ...
    public ProductRowView(Context context, ProductRowAdapter productRowAdapter) {
        super(context);
